...
const ICON = {
  ...
  /* Галочка нарисована по центру квадрата 24×24.
     ...
     приходилась на 9 из 12. В кружке 26 px галочка стоит 14 px, то есть
     сдвиг влево выходил почти на два пикселя — этого довольно, чтобы глаз
     заподозрил неладное, но мало, чтобы понять, что именно. Остальные значки
     набора отцентрованы, ошибка была только в этой. */
  check:  '<path d="M6 11.75l4.5 4.5L18 7.75"/>',
